...
export class ChatwootTrigger implements INodeType {
	...
	async webhook(this: IWebhookFunctions): Promise<IWebhookResponseData> {
		...
		if (event === 'message_created') {
			const filterMessageType = this.getNodeParameter('filterMessageType', false) as boolean;
			if (filterMessageType) {
				const messageType = this.getNodeParameter('messageType') as number;
			...
			const excludePrivate = this.getNodeParameter('excludePrivate', false) as boolean;
